...
<template>
  ...
  >
    <!-- 적립 예정 포인트 카드 -->
    <!-- 접근성 1차 수정 role="link" role="button" -->
    <div
      role="button"
      class="sc-point-card sc-point-card__shadow"
      aria-label="적립 예정 포인트 149,432포인트, 더보기"
    >
      <ListCard
        variant="outline"
        shadow
      ...
      >
        <ListItem align="top">
          <template #leftMainText>
            <span class="sc-point-card__left-content">
              <!-- 접근성 수정 : 장식등 심미적 효과를 위한 이미지에는 대체 텍스트를 생략해야 함 -->
              <!-- alt="포인트 아이콘" 삭제-->
                <!-- [260102]아이콘 이미지 로티로 변경 -->
                <!-- <img
                ...
                <ScLottie
                  :animation-link="
                    $cdnURL + '/images/lottie/common/today_appTech_point.json'
                  "
                  class="sc-point-card__img"
                />
              <span class="sc-point-card__label">적립 예정 포인트</span>
            </span>
          </template>
          <template #rightMainText>
            <span class="sc-point-card__right-content">
              <span class="sc-point-card__amount">149,432P</span>
              <Icon
                name="Chevron_right"
                size="20"
                class="sc-point-card__icon"
              />
            </span>
          </template>
        </ListItem>
    ...
    <div
      role="button"
      class="sc-point-card sc-point-card__solid"
      aria-label="사용 가능 포인트 368,432포인트, 더보기"
    >
      <ListCard
        variant="solid"
        aria-hidden="true"
      >
        <ListItem align="centered">
          <template #leftMainText>
            <span class="sc-point-card__label">사용 가능 포인트</span>
          </template>
          <template #rightMainText>
            <span class="sc-point-card__right-content">
              <span class="sc-point-card__amount">368,432P</span>
              <Icon
                name="Chevron_right"
                size="20"
                class="sc-point-card__icon"
    ...
    <UnorderedList class="sc-unordered__list">
      <UnorderedListItem>
        매일 랜덤포인트, 오늘의 미션, 포인트 팡팡 참여를 통한 적립 포인트 지급은 광고 참여일 기준
        다음날 일괄 적립 됩니다.
      </UnorderedListItem>
      <UnorderedListItem>
        ‘쿠팡 혜택'서비스를 통한 적립 예정 포인트는 ‘쿠팡 혜택'화면에서 제공중입니다.
      </UnorderedListItem>
      <UnorderedListItem> 적립예정포인트 내역은 최근 3개월까지 조회가능합니다. </UnorderedListItem>
    </UnorderedList>
  </FullPopup>
</template>
  ...
  <div class="sc-contents__body">
    <section class="section">
      ...
      <div
        ...
        aria-label="적립 예정 포인트 149,432포인트, 더보기"
      >
        <ListCard variant="outline" shadow aria-hidden="true">
          <ListItem align="top">
            <template #leftMainText>
              <span class="sc-point-card__left-content">
                <!-- 접근성 수정 : 장식등 심미적 효과를 위한 이미지에는 대체 텍스트를 생략해야 함 -->
      ...
      <div
        ...
        aria-label="사용 가능 포인트 368,432포인트, 더보기"
      >
        <ListCard variant="solid" aria-hidden="true">
          <ListItem align="centered">
            <template #leftMainText>
              <span class="sc-point-card__label">사용 가능 포인트</span>
            </template>
      ...
      <UnorderedList class="sc-unordered__list">
        <UnorderedListItem>
          매일 랜덤포인트, 오늘의 미션, 포인트 팡팡 참여를 통한 적립 포인트
          지급은 광고 참여일 기준 다음날 일괄 적립 됩니다.
        </UnorderedListItem>
        <UnorderedListItem>
          ‘쿠팡 혜택'서비스를 통한 적립 예정 포인트는 ‘쿠팡 혜택'화면에서
          제공중입니다.
        </UnorderedListItem>
        <UnorderedListItem>
          적립예정포인트 내역은 최근 3개월까지 조회가능합니다.
        </UnorderedListItem>
      </UnorderedList>
    </section>
  </div>
    ...
    <ul class="shared-list">
      ...
      <li>
        ...
        >
          <template #leftIcon>
            <span aria-hidden="true">
              <ScIcon iconName="solid_facebook" width="36" height="36" />
            </span>
          </template>
        </TextButton>
      </li>
      <li>
        ...
        >
          <template #leftIcon>
            <span aria-hidden="true">
              <ScIcon iconName="solid_X" width="36" height="36" />
            </span>
          </template>
        </TextButton>
      </li>
